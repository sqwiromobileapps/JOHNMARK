...
function InstalledUserAppCard({ app, style }: { app: AppProps; style: any }) {
  ...
  return (
    <TouchableOpacity style={{ padding: 5, height: 110, width: 110 }}>
...
export default InstalledUserAppCard;
